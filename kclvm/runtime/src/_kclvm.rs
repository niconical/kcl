...
pub enum ApiFunc {
    ...
    kclvm_context_args_clear,
    kclvm_context_args_get,
    kclvm_context_args_set,
    kclvm_context_clear_all_types,
    ...
    kclvm_units_to_u,
    kclvm_value_Bool,
    kclvm_value_Bool_ptr,
    kclvm_value_Decorator,
    kclvm_value_Dict,
    kclvm_value_False,
    kclvm_value_Float,
    kclvm_value_Float_ptr,
